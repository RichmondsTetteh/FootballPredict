...
for col in base_columns + ['HomeExpectedGoals', 'AwayExpectedGoals']:
    label = col
    default_value = 0.0  # Start as float
    step_size = 0.01
    min_value = None
    max_value = None
    ...
    if col == 'HomeElo':
        ...
        label = "Handicap Size"
        default_value = 0.0  # float
        min_value = -2.0  # float
        max_value = 2.0  # float
        step_size = 0.25  # float
    elif col == 'Over25':
        ...
        min_value = 0.0  # float
        max_value = 1.0  # float
        step_size = 0.01  # float  # All float
